...
class BraketServiceTest {
  ...
  @Mock
  private BraketTaskClient taskClient;
  @Mock
  private BraketParameterHandler parameterHandler;
  @Mock
  private BraketS3Client s3Client;
  @InjectMocks
  private BraketService service;
  ...
  void submitTask_withDirectParams_passesRawActionToClient() {
    String rawAction =
        "{\"braketSchemaHeader\":{\"name\":\"braket.ir.openqasm.program\",\"version\":\"1\"},\"source\":\"" + CIRCUIT +
            "\",\"inputs\":{}}";
