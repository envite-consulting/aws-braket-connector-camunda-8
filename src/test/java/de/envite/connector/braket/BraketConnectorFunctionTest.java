...
import static de.envite.connector.braket.BraketConstants.STATUS_COMPLETED;
import static de.envite.connector.braket.BraketConstants.STATUS_QUEUED;
import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.Mockito.*;

import de.envite.connector.braket.dto.*;
...
class BraketConnectorFunctionTest {
  ...
  private BraketSubmitTaskRequestDto buildDirectParamsRequest() {
    return BraketSubmitTaskRequestDto.builder()
        ...
        .params(
            "{\"braketSchemaHeader\":{\"name\":\"braket.ir.openqasm.program\",\"version\":\"1\"},\"source\":\"OPENQASM 3.0; qubit[1] q; x q[0];\",\"inputs\":{}}")
        .shots(1000)
        .s3ResultBucket(S3_BUCKET).s3KeyPrefix(S3_PREFIX)
        .waitForResult(false)
        .build();
